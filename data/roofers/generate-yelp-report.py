#!/usr/bin/env python3
"""
Generate a comprehensive report from Yelp review analysis
Creates a markdown report with ratings, positive/negative reviews, and statistics
"""
...
def generate_report(input_file: str, output_file: str = None):
    """Generate a markdown report from Yelp analysis results"""
...
def generate_summary_csv(input_file: str, output_file: str = None):
    ...
    with open(output_file, 'w', newline='', encoding='utf-8') as f:
        ...
        writer.writerow([
            ...
            'Positive Reviews', 'Negative Reviews', 'Total Reviews Analyzed'
        ])
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Generate Yelp analysis report')
