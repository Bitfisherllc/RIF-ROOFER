  ...
  const linkSections = [
    {
      ...
      links: [
        { href: '/service-areas', label: 'Explore Service Areas', icon: faMapLocationDot },
    ...
    },
    {
      ...
      links: [
        ...
        { href: '/partnerships/sponsorship-subscription', label: 'Sponsored results', icon: faHandshake },
        { href: '/partnerships/general-listings', label: 'General Listings', icon: faHandshake },
        { href: '/training-schedule', label: 'Training Schedule', icon: faHandshake },
