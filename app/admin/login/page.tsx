...
function AdminLoginForm() {
  ...
  const redirect = searchParams.get('redirect') || '/admin/roofers';
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-rif-black mb-2 flex items-center justify-center gap-2">
              <FontAwesomeIcon icon={faCog} className="h-6 w-6 text-rif-blue-500" />
              Admin Portal
            </h1>
